      ...
      <div className="relative w-full z-10 fixed top-0 bg-gray-200 border-b border-grey-light">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-4">
          <div className="pl-4 flex items-center">
            ...
            <a
              className="text-teal-700 text-base no-underline hover:no-underline font-extrabold text-xl pl-2"
              href="#"
            >
              Movie DB
            </a>
            <div
              id="search-toggle"
              className="relative search-icon cursor-pointer ml-20"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="absolute fa fa-search text-gray-400 top-5 left-4 w-6 h-6"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
